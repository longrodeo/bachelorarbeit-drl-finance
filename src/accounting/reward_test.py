...
df_ic   = compute_rewards_from_snapshots(acc, spec=RewardSpec(kind="icvar", lambda_=1.0, icvar_mode="ex_post"), out_name="rewards_icvar.parquet")
df_icdd = compute_rewards_from_snapshots(acc, spec=RewardSpec(kind="icvar_dd", lambda_=1.0, gamma=1.0, icvar_mode="ex_post"), out_name="rewards_icvar_dd.parquet")
